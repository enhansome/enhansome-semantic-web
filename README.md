...
To add something to the list please either submit a pull request or add a comment with a link to [issues/awesomelets](https://github.com/semantalytics/awesome-semantic-web/issues/81) ⭐ 1,694 | 🐛 31 | 📅 2026-09-08. Pull requests will be evaluated immediately for inclusion while awesomelets will be evaluated at some indeterminate time in the future.

Looking for something but can't find it? Add it to the ["Does it exist"](https://github.com/semantalytics/awesome-semantic-web/issues/74) ⭐ 1,694 | 🐛 31 | 📅 2026-09-08 list and we'll keep an eye out for it. If it's a good idea maybe someone will come along and create it!
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,943 | 🐛 155 | 🌐 Rust | 📅 2026-09-22 - (OS) a graph database implementing the SPARQL standard and written in Rust.
...
* [QLever](https://github.com/ad-freiburg/qlever) ⭐ 905 | 🐛 399 | 🌐 C++ | 📅 2026-09-22 - (OS) a SPARQL engine that can efficiently index and query very large knowledge graphs with over a trillion triples on a single standard PC or server
...
* [HeFQUIN](https://github.com/LiUSemWeb/HeFQUIN) ⭐ 35 | 🐛 38 | 🌐 Java | 📅 2026-09-22 - A query federation engine for heterogeneous federations of graph data sources.
...
* [QLever](https://github.com/ad-freiburg/QLever) ⭐ 905 | 🐛 399 | 🌐 C++ | 📅 2026-09-22 - Highly efficient query engine for SPARQL+Text.
...
* [Sparklis](https://github.com/sebferre/sparklis) ⭐ 52 | 🐛 3 | 🌐 OCaml | 📅 2025-08-09 - natural language query builder to explore and query endpoints with all the power of SPARQL yet without any knowledge of SPARQL.
...
* [ontop](https://github.com/ontop/ontop) ⭐ 956 | 🐛 108 | 🌐 Java | 📅 2026-09-21 - Ontop is a platform to query relational databases as Virtual RDF Graphs using SPARQL. It's fast and is packed with features.
...
* [SPARQL Anything](https://github.com/SPARQL-Anything/sparql.anything) ⭐ 307 | 🐛 64 | 🌐 Java | 📅 2026-09-22 - A system for Semantic Web [re-engineering](https://arxiv.org/pdf/2106.02361.pdf) that allows users to query anything with SPARQL.
...
* [LinkML-Scala](https://github.com/NeverBlink-OSS/linkml-scala) ⭐ 55 | 🐛 3 | 🌐 Scala | 📅 2026-09-22 – fast, portable (JS/JVM/native), and robust implementation of [LinkML](https://linkml.io/).
...
* [shex.js](https://github.com/shexSpec/shex.js) ⭐ 62 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-22 - JavaScript implementation of Shape Expressions (ShEx).
...
* [RDFlib](https://github.com/RDFLib/rdflib) ⭐ 2,517 | 🐛 384 | 🌐 Python | 📅 2026-09-21 - A Python library for RDF manipulation, storage & serialization.
...
* [kglab](https://github.com/DerwenAI/kglab/) ⭐ 690 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2026-01-25 -  The kglab library provides a simple abstraction layer in Python for building knowledge graphs.
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,943 | 🐛 155 | 🌐 Rust | 📅 2026-09-22 - Oxigraph is a graph database implementing the SPARQL standard.
...
* [PurRDF](https://github.com/Blackcat-Informatics/purrdf) ⭐ 46 | 🐛 8 | 🌐 Rust | 📅 2026-09-22 - RDF 1.2 engine with SPARQL, SHACL, ShEx and entailment, exposing one identical behaviour in Rust, Python, WebAssembly and C.
...
* [Weviate](https://github.com/creativesoftwarefdn/weaviate) ⭐ 16,839 | 🐛 743 | 🌐 Go | 📅 2026-09-22
...
* [comunica](https://github.com/comunica/comunica) ⭐ 610 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-21 - Flexible meta query engine for the Web.
...
* [pyLDAPI](https://github.com/rdflib/pyLDAPI) ⭐ 43 | 🐛 10 | 🌐 Python | 📅 2025-01-18 - A Python [rdflib](https://github.com/rdflib/RDFlib/) ⭐ 2,517 | 🐛 384 | 🌐 Python | 📅 2026-09-21-based API framework for Linked Data via the W3C's [Content Negotiation by Profile](https://w3c.github.io/dx-connegp/connegp/)
...
* [Widoco](https://github.com/dgarijo/Widoco) ⭐ 398 | 🐛 154 | 🌐 JavaScript | 📅 2026-09-22 - A Wizard for documenting and publishing ontologies on the Web.
...
* [pyLODE](https://github.com/rdflib/pyLODE/) ⭐ 228 | 🐛 80 | 🌐 Python | 📅 2026-09-19 - A Python [rdflib](https://github.com/rdflib/RDFlib/) ⭐ 2,517 | 🐛 384 | 🌐 Python | 📅 2026-09-21-based implementation of the [LODE](http://ceur-ws.org/Vol-932/paper12.pdf) ontology documentation tool
* [grlc](https://github.com/CLARIAH/grlc) ⭐ 151 | 🐛 35 | 🌐 Python | 📅 2026-09-01 - Web APIs from SPARQL queries.
* [Web-Client](https://github.com/AtomGraph/Web-Client) ⭐ 123 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-22 - Generic Linked Data browser and UX component framework.
...
* [schema\_salad](https://github.com/common-workflow-language/schema_salad) ⭐ 86 | 🐛 93 | 🌐 Python | 📅 2026-09-22 - Semantic Annotations for Linked Avro Data.
...
- [Qlue-ls](https://github.com/IoannisNezis/Qlue-ls) ⭐ 49 | 🐛 11 | 🌐 Rust | 📅 2026-09-22 - A powerfull SPARQL language server and formatter. Providing: auto-completion, hover-info, formatting, code-actions, diagnostics and more.
...
* [OntoGPT](https://github.com/monarch-initiative/ontogpt/) ⭐ 1,025 | 🐛 80 | 🌐 Jupyter Notebook | 📅 2026-09-10 - Tools for populating semantic schemas from unstructured text using Large Language Models (LLMs)
...
* [LinkedPipes-ETL](https://github.com/linkedpipes/etl) ⭐ 162 | 🐛 199 | 🌐 Java | 📅 2026-06-12 - Linked Data ETL pipeline.
...
* [totogo/awesome-knowledge-graph](https://github.com/totogo/awesome-knowledge-graph) ⭐ 1,894 | 🐛 23 | 📅 2026-09-11

* [shaoxiongi/awesome-knowlege-graph](https://github.com/shaoxiongji/awesome-knowledge-graph) ⭐ 1,796 | 🐛 0 | 🌐 JavaScript | 📅 2022-10-07
...
* [OWL-API](https://github.com/owlcs/owlapi) ⭐ 933 | 🐛 107 | 🌐 Java | 📅 2026-09-06 - The OWL API is a Java API for creating, manipulating and serialising OWL Ontologies.

* [awesome-ontology](https://github.com/ozekik/awesome-ontology) ⭐ 704 | 🐛 1 | 📅 2026-06-07 - Similar to this list
...
* [nanopub-java](https://github.com/Nanopublication/nanopub-java) ⭐ 33 | 🐛 26 | 🌐 Java | 📅 2026-09-22
