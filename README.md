...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,874 | 🐛 150 | 🌐 Rust | 📅 2026-09-09 - (OS) a graph database implementing the SPARQL standard and written in Rust.
...
* [QLever](https://github.com/ad-freiburg/qlever) ⭐ 897 | 🐛 400 | 🌐 C++ | 📅 2026-09-09 - (OS) a SPARQL engine that can efficiently index and query very large knowledge graphs with over a trillion triples on a single standard PC or server
...
* [Parliament](https://github.com/SemWebCentral/parliament) ⭐ 67 | 🐛 3 | 🌐 Java | 📅 2026-09-02 - (OS).
...
* [Virtuoso](https://virtuoso.openlinksw.com/) - ($/OS).
  * [virtuoso-opensource](https://github.com/openlink/virtuoso-opensource) ⭐ 975 | 🐛 673 | 🌐 C | 📅 2026-08-24
...
* [hyrise](https://github.com/hyrise/hyrise) ⭐ 871 | 🐛 93 | 🌐 C++ | 📅 2026-09-09 - Hyrise is a research in-memory database.
...
* [HeFQUIN](https://github.com/LiUSemWeb/HeFQUIN) ⭐ 35 | 🐛 35 | 🌐 Java | 📅 2026-09-09 - A query federation engine for heterogeneous federations of graph data sources.
...
* [QLever](https://github.com/ad-freiburg/QLever) ⭐ 897 | 🐛 400 | 🌐 C++ | 📅 2026-09-09 - Highly efficient query engine for SPARQL+Text.
...
* [Trifid](https://github.com/zazuko/trifid) ⭐ 102 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-08 - Lightweight Linked Data Server and Proxy
...
* [sparql-gremlin](https://github.com/apache/tinkerpop/tree/master/sparql-gremlin) ⭐ 2,144 | 🐛 31 | 🌐 Java | 📅 2026-09-09 - SPARQL to Gremlin Translator available as a plugin of the popular Apache TinkerPop graph computing framework.
...
* [SPARQL Anything](https://github.com/SPARQL-Anything/sparql.anything) ⭐ 307 | 🐛 61 | 🌐 Java | 📅 2026-09-09 - A system for Semantic Web [re-engineering](https://arxiv.org/pdf/2106.02361.pdf) that allows users to query anything with SPARQL.
...
* [Ontology Development Kit](https://github.com/INCATools/ontology-development-kit/) ⭐ 369 | 🐛 75 | 🌐 Dockerfile | 📅 2026-09-07 - set up a git repo for developing an ontology
...
* [LinkML-Scala](https://github.com/NeverBlink-OSS/linkml-scala) ⭐ 46 | 🐛 8 | 🌐 Scala | 📅 2026-09-09 – fast, portable (JS/JVM/native), and robust implementation of [LinkML](https://linkml.io/).
* [dosdp-tools](https://github.com/INCATools/dosdp-tools/) ⭐ 33 | 🐛 37 | 🌐 Scala | 📅 2026-05-21 - dead simple owl design patterns (template tool)
...
* [rdf2go](https://github.com/deiu/rdf2go) ⭐ 81 | 🐛 1 | 🌐 Go | 📅 2024-12-12 - Native golang library for RDF.
* [knakk/rdf](https://github.com/knakk/rdf) ⭐ 76 | 🐛 7 | 🌐 Go | 📅 2026-09-07 - RDF library for Go.
...
* [N3.js](https://github.com/RubenVerborgh/N3.js) ⭐ 796 | 🐛 65 | 🌐 JavaScript | 📅 2026-09-07
* [rdflib.js](https://github.com/linkeddata/rdflib.js) ⭐ 597 | 🐛 136 | 🌐 HTML | 📅 2026-09-07 - Linked Data API for JavaScript.
...
* [shex.js](https://github.com/shexSpec/shex.js) ⭐ 62 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-07 - JavaScript implementation of Shape Expressions (ShEx).
...
* sweetrdf - Collection of RDF-libraries using modern PHP functionality
  * [rdfInterface](https://github.com/sweetrdf/rdfInterface) ⭐ 7 | 🐛 2 | 🌐 PHP | 📅 2026-09-08 - Common interfaces for each RDF stack layer (parser, serializer, dataset, SPARQL client, etc.) to enable interoperability between different implementations. Think of it as PSR for RDF.
...
* [RDFlib](https://github.com/RDFLib/rdflib) ⭐ 2,511 | 🐛 383 | 🌐 Python | 📅 2026-09-09 - A Python library for RDF manipulation, storage & serialization.
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,874 | 🐛 150 | 🌐 Rust | 📅 2026-09-09 - Oxigraph is a graph database implementing the SPARQL standard.
...
* [PurRDF](https://github.com/Blackcat-Informatics/purrdf) ⭐ 45 | 🐛 6 | 🌐 Rust | 📅 2026-09-09 - RDF 1.2 engine with SPARQL, SHACL, ShEx and entailment, exposing one identical behaviour in Rust, Python, WebAssembly and C.
...
* [ELOT](https://github.com/johanwk/elot) ⭐ 33 | 🐛 14 | 🌐 Emacs Lisp | 📅 2026-08-25 - Emacs Literate Ontology Tool, write OWL ontologies using org-mode
...
* [RickView](https://github.com/konradhoeffner/rickview) ⭐ 37 | 🐛 15 | 🌐 Rust | 📅 2026-09-07 - RDF browser for small knowledge bases written in Rust using an in-memory graph, doesn't require a SPARQL endpoint. Optimized for high performance and low resource usage.
...
* [Sparnatural](https://github.com/sparna-git/Sparnatural) ⭐ 306 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-09
...
* [Weviate](https://github.com/creativesoftwarefdn/weaviate) ⭐ 16,797 | 🐛 730 | 🌐 Go | 📅 2026-09-09
...
* [comunica](https://github.com/comunica/comunica) ⭐ 583 | 🐛 85 | 🌐 TypeScript | 📅 2026-09-09 - Flexible meta query engine for the Web.
...
* [pyLDAPI](https://github.com/rdflib/pyLDAPI) ⭐ 43 | 🐛 10 | 🌐 Python | 📅 2025-01-18 - A Python [rdflib](https://github.com/rdflib/RDFlib/) ⭐ 2,511 | 🐛 383 | 🌐 Python | 📅 2026-09-09-based API framework for Linked Data via the W3C's [Content Negotiation by Profile](https://w3c.github.io/dx-connegp/connegp/)
...
* [Widoco](https://github.com/dgarijo/Widoco) ⭐ 397 | 🐛 154 | 🌐 JavaScript | 📅 2026-09-01 - A Wizard for documenting and publishing ontologies on the Web.
...
* [pyLODE](https://github.com/rdflib/pyLODE/) ⭐ 227 | 🐛 78 | 🌐 Python | 📅 2026-08-17 - A Python [rdflib](https://github.com/rdflib/RDFlib/) ⭐ 2,511 | 🐛 383 | 🌐 Python | 📅 2026-09-09-based implementation of the [LODE](http://ceur-ws.org/Vol-932/paper12.pdf) ontology documentation tool
* [grlc](https://github.com/CLARIAH/grlc) ⭐ 151 | 🐛 35 | 🌐 Python | 📅 2026-09-01 - Web APIs from SPARQL queries.
* [Web-Client](https://github.com/AtomGraph/Web-Client) ⭐ 123 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-09 - Generic Linked Data browser and UX component framework.
...
- [Qlue-ls](https://github.com/IoannisNezis/Qlue-ls) ⭐ 49 | 🐛 10 | 🌐 Rust | 📅 2026-09-09 - A powerfull SPARQL language server and formatter. Providing: auto-completion, hover-info, formatting, code-actions, diagnostics and more.
- [rdfless](https://github.com/larsw/rdfless/) ⭐ 8 | 🐛 1 | 🌐 Rust | 📅 2026-09-09 - A pager and pretty-printer for Turtle/TriG/N-triples and N-Quads written in Rust.
...
* [OntoGPT](https://github.com/monarch-initiative/ontogpt/) ⭐ 1,006 | 🐛 77 | 🌐 Jupyter Notebook | 📅 2026-09-09 - Tools for populating semantic schemas from unstructured text using Large Language Models (LLMs)
...
* [totogo/awesome-knowledge-graph](https://github.com/totogo/awesome-knowledge-graph) ⭐ 1,887 | 🐛 23 | 📅 2026-02-28
...
* [awesome-ontology](https://github.com/ozekik/awesome-ontology) ⭐ 694 | 🐛 1 | 📅 2026-06-07 - Similar to this list
...
* [amazon-neptune-tools](https://github.com/awslabs/amazon-neptune-tools) ⭐ 314 | 🐛 10 | 🌐 Python | 📅 2026-09-03 - Tools and utilities to enable loading data and building graph applications with Amazon Neptune.
...
* [jsonld-streaming-parser.js](https://github.com/rubensworks/jsonld-streaming-parser.js) ⭐ 91 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-18 - A fast and lightweight streaming JSON-LD parser for JavaScript.
...
* [nanopub-java](https://github.com/Nanopublication/nanopub-java) ⭐ 33 | 🐛 27 | 🌐 Java | 📅 2026-09-09
