...
To add something to the list please either submit a pull request or add a comment with a link to [issues/awesomelets](https://github.com/semantalytics/awesome-semantic-web/issues/81) ⭐ 1,682 | 🐛 32 | 📅 2026-09-04. Pull requests will be evaluated immediately for inclusion while awesomelets will be evaluated at some indeterminate time in the future.

Looking for something but can't find it? Add it to the ["Does it exist"](https://github.com/semantalytics/awesome-semantic-web/issues/74) ⭐ 1,682 | 🐛 32 | 📅 2026-09-04 list and we'll keep an eye out for it. If it's a good idea maybe someone will come along and create it!
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,860 | 🐛 148 | 🌐 Rust | 📅 2026-09-02 - (OS) a graph database implementing the SPARQL standard and written in Rust.
...
* [QLever](https://github.com/ad-freiburg/qlever) ⭐ 894 | 🐛 403 | 🌐 C++ | 📅 2026-09-04 - (OS) a SPARQL engine that can efficiently index and query very large knowledge graphs with over a trillion triples on a single standard PC or server
...
* [hyrise](https://github.com/hyrise/hyrise) ⭐ 871 | 🐛 93 | 🌐 C++ | 📅 2026-09-04 - Hyrise is a research in-memory database.
...
* [sepa](https://github.com/arces-wot/SEPA) ⭐ 33 | 🐛 29 | 🌐 Java | 📅 2026-09-02 - A JAVA implementation of the SPARQL Event Processing Architecture including the engine, APIs and tools.
...
* [QLever](https://github.com/ad-freiburg/QLever) ⭐ 894 | 🐛 403 | 🌐 C++ | 📅 2026-09-04 - Highly efficient query engine for SPARQL+Text.
...
* [SPARQL Anything](https://github.com/SPARQL-Anything/sparql.anything) ⭐ 306 | 🐛 61 | 🌐 Java | 📅 2026-09-04 - A system for Semantic Web [re-engineering](https://arxiv.org/pdf/2106.02361.pdf) that allows users to query anything with SPARQL.
...
* [Ontology Development Kit](https://github.com/INCATools/ontology-development-kit/) ⭐ 368 | 🐛 74 | 🌐 Dockerfile | 📅 2026-08-31 - set up a git repo for developing an ontology
...
* [eye](https://github.com/josd/eye) ⭐ 174 | 🐛 24 | 🌐 Prolog | 📅 2026-08-22 - Euler Yet another proof Engine.
...
* [N3.js](https://github.com/RubenVerborgh/N3.js) ⭐ 794 | 🐛 63 | 🌐 JavaScript | 📅 2026-09-03
...
* [shex.js](https://github.com/shexSpec/shex.js) ⭐ 62 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-04 - JavaScript implementation of Shape Expressions (ShEx).
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,860 | 🐛 148 | 🌐 Rust | 📅 2026-09-02 - Oxigraph is a graph database implementing the SPARQL standard.
* [sophia\_rs](https://github.com/pchampin/sophia_rs) ⭐ 330 | 🐛 24 | 🌐 Rust | 📅 2026-08-20 - Sophia: a Rust toolkit for RDF and Linked Data.
* [Horned OWL](https://github.com/phillord/horned-owl) ⭐ 104 | 🐛 16 | 🌐 Rust | 📅 2026-09-03 - Horned-OWL is a library for manipulating OWL data.
...
* [PurRDF](https://github.com/Blackcat-Informatics/purrdf) ⭐ 35 | 🐛 4 | 🌐 Rust | 📅 2026-09-04 - RDF 1.2 engine with SPARQL, SHACL, ShEx and entailment, exposing one identical behaviour in Rust, Python, WebAssembly and C.
...
* [ELOT](https://github.com/johanwk/elot) ⭐ 32 | 🐛 14 | 🌐 Emacs Lisp | 📅 2026-08-25 - Emacs Literate Ontology Tool, write OWL ontologies using org-mode
...
* [Weviate](https://github.com/creativesoftwarefdn/weaviate) ⭐ 16,785 | 🐛 711 | 🌐 Go | 📅 2026-09-04
...
- [Qlue-ls](https://github.com/IoannisNezis/Qlue-ls) ⭐ 49 | 🐛 14 | 🌐 Rust | 📅 2026-09-04 - A powerfull SPARQL language server and formatter. Providing: auto-completion, hover-info, formatting, code-actions, diagnostics and more.
...
* [OntoGPT](https://github.com/monarch-initiative/ontogpt/) ⭐ 996 | 🐛 78 | 🌐 Jupyter Notebook | 📅 2026-06-22 - Tools for populating semantic schemas from unstructured text using Large Language Models (LLMs)
...
* [pySHACL](https://github.com/RDFLib/pySHACL) ⭐ 341 | 🐛 45 | 🌐 Python | 📅 2026-07-28 - A Python validator for SHACL.
...
* [SEPA](https://github.com/arces-wot/SEPA/blob/master/README.md) ⭐ 33 | 🐛 29 | 🌐 Java | 📅 2026-09-02
