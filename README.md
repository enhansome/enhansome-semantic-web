...
To add something to the list please either submit a pull request or add a comment with a link to [issues/awesomelets](https://github.com/semantalytics/awesome-semantic-web/issues/81) ⭐ 1,677 | 🐛 31 | 📅 2026-07-20. Pull requests will be evaluated immediately for inclusion while awesomelets will be evaluated at some indeterminate time in the future.

Looking for something but can't find it? Add it to the ["Does it exist"](https://github.com/semantalytics/awesome-semantic-web/issues/74) ⭐ 1,677 | 🐛 31 | 📅 2026-07-20 list and we'll keep an eye out for it. If it's a good idea maybe someone will come along and create it!
...
* [See list of RDF Triple Store propducts](https://github.com/graphgeeks-lab/awesome-graph-universe?tab=readme-ov-file#triple-stores-rdf-databases) ⭐ 159 | 🐛 6 | 📅 2025-08-26
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,813 | 🐛 141 | 🌐 Rust | 📅 2026-08-12 - (OS) a graph database implementing the SPARQL standard and written in Rust.
...
* [QLever](https://github.com/ad-freiburg/qlever) ⭐ 880 | 🐛 379 | 🌐 C++ | 📅 2026-08-11 - (OS) a SPARQL engine that can efficiently index and query very large knowledge graphs with over a trillion triples on a single standard PC or server
...
* [QuitStore](https://github.com/AKSW/QuitStore) ⭐ 114 | 🐛 54 | 🌐 Python | 📅 2024-06-27 - Quads in Git - Git versioned RDF Triple Store with support for branching and mergin and more.
...
* [Parliament](https://github.com/SemWebCentral/parliament) ⭐ 66 | 🐛 3 | 🌐 Java | 📅 2026-08-03 - (OS).
* [redstore](https://github.com/njh/redstore) ⭐ 64 | 🐛 6 | 🌐 C | 📅 2021-07-29 - (OS) RedStore is a lightweight RDF triplestore written in C using the Redland library.
...
* [kineo](https://github.com/kasei/kineo/) ⭐ 39 | 🐛 0 | 🌐 Swift | 📅 2024-11-17 - (OS) A persistent RDF quadstore and SPARQL engine.
...
* [Vedas](https://github.com/Remixman/Vedas) ⭐ 8 | 🐛 0 | 🌐 Cuda | 📅 2024-03-26 - (OS) VEDAS is a RDF store engine that be able to query with SPARQL and run on single GPU.
...
* [Virtuoso](https://virtuoso.openlinksw.com/) - ($/OS).
  * [virtuoso-opensource](https://github.com/openlink/virtuoso-opensource) ⭐ 970 | 🐛 647 | 🌐 C | 📅 2026-08-05
...
* [sepa](https://github.com/arces-wot/SEPA) ⭐ 33 | 🐛 27 | 🌐 Java | 📅 2026-08-08 - A JAVA implementation of the SPARQL Event Processing Architecture including the engine, APIs and tools.
...
* [HeFQUIN](https://github.com/LiUSemWeb/HeFQUIN) ⭐ 35 | 🐛 33 | 🌐 Java | 📅 2026-08-11 - A query federation engine for heterogeneous federations of graph data sources.
...
* [QLever](https://github.com/ad-freiburg/QLever) ⭐ 880 | 🐛 379 | 🌐 C++ | 📅 2026-08-11 - Highly efficient query engine for SPARQL+Text.
...
* [Trifid](https://github.com/zazuko/trifid) ⭐ 102 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-06 - Lightweight Linked Data Server and Proxy
...
* [Sparklis](https://github.com/sebferre/sparklis) ⭐ 50 | 🐛 3 | 🌐 OCaml | 📅 2025-08-09 - natural language query builder to explore and query endpoints with all the power of SPARQL yet without any knowledge of SPARQL.
* [SparqlProg](https://github.com/cmungall/sparqlprog) ⭐ 49 | 🐛 5 | 🌐 Prolog | 📅 2023-01-16 - composable SPARQL using logic programming
...
* [SPARQL2NL](https://github.com/AKSW/SPARQL2NL) ⭐ 44 | 🐛 8 | 🌐 Java | 📅 2016-03-09
...
* [reactive-sparql](https://github.com/modelfabric/reactive-sparql) ⭐ 13 | 🐛 1 | 🌐 Scala | 📅 2023-09-18
...
* [visu](https://github.com/jiemakel/visu) ⭐ 10 | 🐛 0 | 🌐 LiveScript | 📅 2016-02-26 - Visual SPARQL query tool.
* [snap-sparql-query](https://github.com/protegeproject/snap-sparql-query) ⭐ 7 | 🐛 21 | 🌐 Java | 📅 2018-07-25
* [SPARQL2Git](https://github.com/albertmeronyo/SPARQL2Git) ⭐ 6 | 🐛 4 | 🌐 HTML | 📅 2017-03-16 - Easily store and curate SPARQL queries (and their associated Linked Data APIs) in GitHub.
...
* [IGUANA](https://github.com/dice-group/IGUANA) ⭐ 25 | 🐛 32 | 🌐 Java | 📅 2026-01-23
* [IGUANA](https://github.com/AKSW/IGUANA) ⭐ 25 | 🐛 32 | 🌐 Java | 📅 2026-01-23 - IGUANA is a benchmark execution framework for triple stores.
* [GTFS-Madrid-Bench](https://github.com/oeg-upm/gtfs-bench) ⭐ 21 | 🐛 6 | 🌐 Python | 📅 2025-03-20 - A benchmark for performance and scalability of knowledge graph construction from heterogeneous data sources
...
* [LDFlex](https://github.com/RubenVerborgh/LDflex) ⭐ 196 | 🐛 37 | 🌐 JavaScript | 📅 2026-08-07 - A JavaScript DSL for querying Linked Data on the Web.
* [HeFQUIN](https://github.com/LiUSemWeb/HeFQUIN) ⭐ 35 | 🐛 33 | 🌐 Java | 📅 2026-08-11 - A query federation engine for heterogeneous federations of graph data sources.
...
* [Elda](https://github.com/epimorphics/elda) ⭐ 57 | 🐛 25 | 🌐 Java | 📅 2026-08-04 - Linked data platform from Epimorphics.
...
* [any2rdf](https://github.com/esbranson/any2rdf) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2013-08-18
...
* [TabLinker](https://github.com/Data2Semantics/TabLinker) ⭐ 39 | 🐛 19 | 🌐 Python | 📅 2014-03-17
...
* [JOPA](https://github.com/kbss-cvut/jopa) ⭐ 44 | 🐛 20 | 🌐 Java | 📅 2026-08-11 - A Java object-triple mapping library for RDF4J, Jena and OWL API.
* [PA4RDF](https://github.com/Claudenw/PA4RDF) ⭐ 12 | 🐛 4 | 🌐 Java | 📅 2024-02-21 - functionality on top of an RDF store while accounting for and exploiting the fundamental differences between graph storage and relational storage.
...
* [Sparqlify](https://github.com/AKSW/Sparqlify) ⭐ 134 | 🐛 53 | 🌐 Java | 📅 2024-10-11 - Sparql -> SQL Rewriter enabling virtual RDB -> RDF mappings.
* [quetzal](https://github.com/Quetzal-RDF/quetzal) ⭐ 106 | 🐛 8 | 🌐 Java | 📅 2022-12-12 - SPARQL to SQL translation engine for multiple backends, such as DB2, PostgreSQL and Apache Spark.
...
* [sparql-gremlin](https://github.com/apache/tinkerpop/tree/master/sparql-gremlin) ⭐ 2,143 | 🐛 48 | 🌐 Java | 📅 2026-08-13 - SPARQL to Gremlin Translator available as a plugin of the popular Apache TinkerPop graph computing framework.
...
* [ontop](https://github.com/ontop/ontop) ⭐ 909 | 🐛 104 | 🌐 Java | 📅 2026-07-13 - Ontop is a platform to query relational databases as Virtual RDF Graphs using SPARQL. It's fast and is packed with features.
...
* [rdf2rml](https://github.com/VladimirAlexiev/rdf2rml) ⭐ 58 | 🐛 20 | 🌐 Perl | 📅 2026-07-28 - R2RML Generation from simple examples.
...
* [Map-On](https://github.com/arc-lasalle/Map-On) ⭐ 21 | 🐛 0 | 🌐 JavaScript | 📅 2019-01-28 - A web-based editor for visual ontology mapping for R2RML documents.
...
* [SDM-RDFizer](https://github.com/SDM-TIB/SDM-RDFizer) ⭐ 138 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - RML engine for efficient transformation of CSV, RDB, XML and JSON to RDF
* [CARML](https://github.com/carml/carml) ⭐ 114 | 🐛 22 | 🌐 Java | 📅 2026-08-07 - CARML RML engine for mapping CSV, XML and JSON files to RDF
...
* [SPARQL Anything](https://github.com/SPARQL-Anything/sparql.anything) ⭐ 304 | 🐛 60 | 🌐 Java | 📅 2026-08-13 - A system for Semantic Web [re-engineering](https://arxiv.org/pdf/2106.02361.pdf) that allows users to query anything with SPARQL.
* [sparql-generate](https://github.com/sparql-generate/sparql-generate) ⭐ 70 | 🐛 21 | 🌐 HTML | 📅 2026-08-08
...
* [doap](https://github.com/edumbill/doap) ⭐ 286 | 🐛 21 | 🌐 C# | 📅 2024-06-11 - RDF schema for describing software projects.
...
* [Ontology Development Kit](https://github.com/INCATools/ontology-development-kit/) ⭐ 358 | 🐛 74 | 🌐 Dockerfile | 📅 2026-08-10 - set up a git repo for developing an ontology
...
* [LinkML-Scala](https://github.com/NeverBlink-OSS/linkml-scala) ⭐ 26 | 🐛 4 | 🌐 Scala | 📅 2026-08-12 – fast, portable (JS/JVM/native), and robust implementation of [LinkML](https://linkml.io/).
...
* [Pellet](https://github.com/stardog-union/pellet) ⭐ 352 | 🐛 27 | 🌐 Web Ontology Language | 📅 2017-01-05
* [OWL-RL](https://github.com/RDFLib/OWL-RL) ⭐ 177 | 🐛 25 | 🌐 HTML | 📅 2026-08-06
* [eye](https://github.com/josd/eye) ⭐ 170 | 🐛 25 | 🌐 Prolog | 📅 2026-06-19 - Euler Yet another proof Engine.
* [openllet](https://github.com/Galigator/openllet) ⭐ 130 | 🐛 45 | 🌐 Java | 📅 2025-08-04
* [reasonable](https://github.com/gtfierro/reasonable) ⭐ 130 | 🐛 12 | 🌐 Rust | 📅 2026-06-02 - OWL 2 Reasoner built on DataFrog
* [ELK](https://github.com/liveontologies/elk-reasoner) ⭐ 122 | 🐛 23 | 🌐 Java | 📅 2026-06-13
* [HyLAR](https://github.com/ucbl/HyLAR-Reasoner) ⭐ 64 | 🐛 13 | 🌐 JavaScript | 📅 2023-03-04
* [Whelk](https://github.com/balhoff/whelk) ⭐ 44 | 🐛 14 | 🌐 Scala | 📅 2025-03-05
...
* [serd](https://github.com/drobilla/serd) ⭐ 98 | 🐛 9 | 🌐 C | 📅 2026-07-15 - Lightweight C library for RDF syntax.
...
* [sord](https://github.com/drobilla/sord) ⭐ 18 | 🐛 0 | 🌐 C | 📅 2026-07-04 - Sord is a lightweight C library for storing RDF statements in memory.
...
* [RDF.ex](https://github.com/marcelotto/rdf-ex) ⭐ 126 | 🐛 0 | 🌐 Elixir | 📅 2026-06-10
...
* [rdfkit-go](https://github.com/dpb587/rdfkit-go) ⭐ 6 | 🐛 0 | 🌐 Go | 📅 2026-06-23 - decoders, encoders, and other RDF primitives for Go.
...
* [titanium-json-ld](https://github.com/filip26/titanium-json-ld) ⭐ 164 | 🐛 10 | 🌐 Java | 📅 2026-07-27 - An implementation of the JSON-LD 1.1 (JSON-based Serialization for Linked Data) specification in Java utilizing Jakarta JSON Processing.
...
* [N3.js](https://github.com/RubenVerborgh/N3.js) ⭐ 793 | 🐛 92 | 🌐 JavaScript | 📅 2026-08-10
* [rdflib.js](https://github.com/linkeddata/rdflib.js) ⭐ 592 | 🐛 132 | 🌐 HTML | 📅 2026-08-10 - Linked Data API for JavaScript.
...
* [shex.js](https://github.com/shexSpec/shex.js) ⭐ 62 | 🐛 37 | 🌐 JavaScript | 📅 2026-08-10 - JavaScript implementation of Shape Expressions (ShEx).
...
* [sparqljson-to-tree.js](https://github.com/rubensworks/sparqljson-to-tree.js) ⭐ 19 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-12 - Convert SPARQL JSON results to a tree structure.
...
* [RDFlib](https://github.com/RDFLib/rdflib) ⭐ 2,490 | 🐛 364 | 🌐 Python | 📅 2026-08-12 - A Python library for RDF manipulation, storage & serialization.
...
* [SPARQLWrapper](https://github.com/RDFLib/sparqlwrapper) ⭐ 565 | 🐛 54 | 🌐 Python | 📅 2026-04-30 - A wrapper for a remote SPARQL endpoint.
* [semantic-python-overview](https://github.com/pysemtec/semantic-python-overview) ⭐ 551 | 🐛 2 | 📅 2025-12-07 - List of Python specific semantic web tools and resources.
...
* [OWL-RL](https://github.com/RDFLib/OWL-RL) ⭐ 177 | 🐛 25 | 🌐 HTML | 📅 2026-08-06 - A simple implementation of the OWL2 RL Profile on top of RDFLib.
...
* [PyShEx](https://github.com/hsolbrig/PyShEx) ⭐ 28 | 🐛 44 | 🌐 Jupyter Notebook | 📅 2026-08-01 - ShEx interpreter for ShEx 2.0.
* [pyrdb2rdf](https://github.com/nisavid/pyrdb2rdf) ⚠️ Archived - Python library for converting relational database data to RDF.
* [pyjelly](https://github.com/Jelly-RDF/pyjelly) ⭐ 19 | 🐛 4 | 🌐 Python | 📅 2026-08-01 – Python implementation of the high-performance [Jelly binary format](https://w3id.org/jelly), supporting rdflib.
...
* [open-kgo](https://github.com/mloda-ai/open-kgo) ⭐ 11 | 🐛 11 | 🌐 Python | 📅 2026-08-07 - Unified Python API over nine knowledge-graph backend families (including RDF/SPARQL) that validates each traversal against a declared ontology and rejects semantically invalid hops.
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,813 | 🐛 141 | 🌐 Rust | 📅 2026-08-12 - Oxigraph is a graph database implementing the SPARQL standard.
* [sophia\_rs](https://github.com/pchampin/sophia_rs) ⭐ 325 | 🐛 25 | 🌐 Rust | 📅 2026-05-20 - Sophia: a Rust toolkit for RDF and Linked Data.
* [Horned OWL](https://github.com/phillord/horned-owl) ⭐ 102 | 🐛 12 | 🌐 Rust | 📅 2026-08-10 - Horned-OWL is a library for manipulating OWL data.
...
* [owlish](https://github.com/field33/owlish) ⭐ 22 | 🐛 1 | 🌐 Rust | 📅 2023-07-12 - An OWL library in Rust modeled on the OWL functional syntax.
* [RDFtk](https://github.com/johnstonskj/rust-rdftk) ⭐ 18 | 🐛 6 | 🌐 Rust | 📅 2026-06-29 - An RDF Toolkit for Rust
* [harriet](https://github.com/field33/harriet) ⭐ 11 | 🐛 2 | 🌐 Rust | 📅 2023-07-04 - A format-preserving serialization/deserialization library for Turtle.
...
* [kineo](https://github.com/kasei/kineo) ⭐ 39 | 🐛 0 | 🌐 Swift | 📅 2024-11-17 - A SPARQL endpoint and quadstore written in Swift.
* [swift-sparql-syntax](https://github.com/kasei/swift-sparql-syntax) ⭐ 18 | 🐛 0 | 🌐 Swift | 📅 2024-07-30 - SPARQL 1.1 Parser.
...
* [ELOT](https://github.com/johanwk/elot) ⭐ 31 | 🐛 14 | 🌐 Emacs Lisp | 📅 2026-08-11 - Emacs Literate Ontology Tool, write OWL ontologies using org-mode
...
* [RickView](https://github.com/konradhoeffner/rickview) ⭐ 36 | 🐛 15 | 🌐 Rust | 📅 2026-08-03 - RDF browser for small knowledge bases written in Rust using an in-memory graph, doesn't require a SPARQL endpoint. Optimized for high performance and low resource usage.
...
* [Sparnatural](https://github.com/sparna-git/Sparnatural) ⭐ 303 | 🐛 98 | 🌐 TypeScript | 📅 2026-08-11
...
* [rdfpuml](https://github.com/VladimirAlexiev/rdf2rml) ⭐ 58 | 🐛 20 | 🌐 Perl | 📅 2026-07-28 - True RDF Diagrams.
* [RdfGlance](https://github.com/xdobry/rdfglance) ⭐ 49 | 🐛 9 | 🌐 Rust | 📅 2026-07-23 - Fast desktop RDF graph visualization and data viewer programmed in Rust
* [Reactodia](https://github.com/reactodia/reactodia-workspace) ⭐ 28 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-08 - Ontodia fork with additional features such as grouping and annotations
...
* [Weviate](https://github.com/creativesoftwarefdn/weaviate) ⭐ 16,725 | 🐛 657 | 🌐 Go | 📅 2026-08-13
...
* [QuitStore](https://github.com/AKSW/QuitStore) ⭐ 114 | 🐛 54 | 🌐 Python | 📅 2024-06-27 - Quads in Git - Distributed Version Control for RDF Knowledge Bases.
* [rdf-toolkit](https://github.com/edmcouncil/rdf-toolkit) ⭐ 79 | 🐛 7 | 🌐 Java | 📅 2026-01-22 - RDF Serializer, to be used in a git commit-hook to force automatic correct rewrite of every OWL ontology.
...
* [comunica](https://github.com/comunica/comunica) ⭐ 577 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-11 - Flexible meta query engine for the Web.
...
* [pyLDAPI](https://github.com/rdflib/pyLDAPI) ⭐ 43 | 🐛 10 | 🌐 Python | 📅 2025-01-18 - A Python [rdflib](https://github.com/rdflib/RDFlib/) ⭐ 2,490 | 🐛 364 | 🌐 Python | 📅 2026-08-12-based API framework for Linked Data via the W3C's [Content Negotiation by Profile](https://w3c.github.io/dx-connegp/connegp/)
...
* [pyLODE](https://github.com/rdflib/pyLODE/) ⭐ 227 | 🐛 77 | 🌐 Python | 📅 2026-08-06 - A Python [rdflib](https://github.com/rdflib/RDFlib/) ⭐ 2,490 | 🐛 364 | 🌐 Python | 📅 2026-08-12-based implementation of the [LODE](http://ceur-ws.org/Vol-932/paper12.pdf) ontology documentation tool
...
* [schema\_salad](https://github.com/common-workflow-language/schema_salad) ⭐ 86 | 🐛 103 | 🌐 Python | 📅 2026-08-12 - Semantic Annotations for Linked Avro Data.
...
* [Git2PROV](https://github.com/mmlab/Git2PROV) ⭐ 35 | 🐛 11 | 🌐 JavaScript | 📅 2023-01-23 - Unleash the potential of Git in the new W3C standard for provenance.
...
- [Qlue-ls](https://github.com/IoannisNezis/Qlue-ls) ⭐ 47 | 🐛 13 | 🌐 Rust | 📅 2026-08-12 - A powerfull SPARQL language server and formatter. Providing: auto-completion, hover-info, formatting, code-actions, diagnostics and more.
...
* [pySHACL](https://github.com/RDFLib/pySHACL) ⭐ 339 | 🐛 45 | 🌐 Python | 📅 2026-07-28 - A Python validator for SHACL.
* [TopQuadrant/shacl](https://github.com/TopQuadrant/shacl) ⭐ 244 | 🐛 16 | 🌐 Java | 📅 2026-06-30 - SHACL API in Java based on Apache Jena.
...
* [atramhasis](https://github.com/OnroerendErfgoed/atramhasis) ⭐ 63 | 🐛 62 | 🌐 Python | 📅 2026-08-09
* [VocPrez](https://github.com/RDFLib/VocPrez/) ⚠️ Archived - A Linked Data API for SKOS data presentation
* [java-skos-api](https://github.com/simonjupp/java-skos-api) ⭐ 12 | 🐛 2 | 🌐 Java | 📅 2017-06-09
...
* [LoRiS](https://github.com/WSE-research/LoRiS-LLM-generated-Representations-of-SPARQL-queries) ⭐ 8 | 🐛 4 | 🌐 Python | 📅 2026-08-09 generated natural-language representations of SPARQL queries over Wikidata and DBpedia.

## IIIF

* [IIIF](https://iiif.io/)
* [fester](https://github.com/UCLALibrary/fester) ⭐ 3 | 🐛 0 | 🌐 Java | 📅 2026-07-23

## Other Awesome

* [totogo/awesome-knowledge-graph](https://github.com/totogo/awesome-knowledge-graph) ⭐ 1,880 | 🐛 23 | 📅 2026-02-28
...
* [OWL-API](https://github.com/owlcs/owlapi) ⭐ 921 | 🐛 111 | 🌐 Java | 📅 2026-03-02 - The OWL API is a Java API for creating, manipulating and serialising OWL Ontologies.
...
* [amazon-neptune-tools](https://github.com/awslabs/amazon-neptune-tools) ⭐ 314 | 🐛 10 | 🌐 Java | 📅 2026-08-04 - Tools and utilities to enable loading data and building graph applications with Amazon Neptune.

* [kbpedia](https://github.com/Cognonto/kbpedia) ⭐ 236 | 🐛 2 | 📅 2020-08-04 - KBPedia Knowledge Graph & Knowledge Ontology (KKO).
...
* [grlc](https://github.com/CLARIAH/grlc) ⭐ 151 | 🐛 32 | 🌐 Python | 📅 2026-08-01 - Translates public SPARQL queries into Linked Data APIs automatically.
...
* [jsonld-streaming-parser.js](https://github.com/rubensworks/jsonld-streaming-parser.js) ⭐ 92 | 🐛 23 | 🌐 TypeScript | 📅 2026-07-17 - A fast and lightweight streaming JSON-LD parser for JavaScript.
...
* [stardog.js](https://github.com/stardog-union/stardog.js) ⭐ 84 | 🐛 11 | 🌐 JavaScript | 📅 2026-07-30
...
* [yarrrml-parser](https://github.com/RMLio/yarrrml-parser) ⭐ 56 | 🐛 61 | 🌐 JavaScript | 📅 2026-06-12 - A YARRRML parser library and CLI in Javascript.
...
* [nanopub-java](https://github.com/Nanopublication/nanopub-java) ⭐ 33 | 🐛 14 | 🌐 Java | 📅 2026-08-12

* [SEPA](https://github.com/arces-wot/SEPA/blob/master/README.md) ⭐ 33 | 🐛 27 | 🌐 Java | 📅 2026-08-08
...
* [java-skos-api](https://github.com/simonjupp/java-skos-api) ⭐ 12 | 🐛 2 | 🌐 Java | 📅 2017-06-09 - The SKOS API provides a Java interface and OWL API based implementation of the Simple Knowledge Organisation System (SKOS)
