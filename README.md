...
To add something to the list please either submit a pull request or add a comment with a link to [issues/awesomelets](https://github.com/semantalytics/awesome-semantic-web/issues/81) ⭐ 1,691 | 🐛 31 | 📅 2026-09-08. Pull requests will be evaluated immediately for inclusion while awesomelets will be evaluated at some indeterminate time in the future.

Looking for something but can't find it? Add it to the ["Does it exist"](https://github.com/semantalytics/awesome-semantic-web/issues/74) ⭐ 1,691 | 🐛 31 | 📅 2026-09-08 list and we'll keep an eye out for it. If it's a good idea maybe someone will come along and create it!
...
* [See list of RDF Triple Store propducts](https://github.com/graphgeeks-lab/awesome-graph-universe?tab=readme-ov-file#triple-stores-rdf-databases) ⭐ 164 | 🐛 7 | 📅 2025-08-26
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,921 | 🐛 154 | 🌐 Rust | 📅 2026-09-18 - (OS) a graph database implementing the SPARQL standard and written in Rust.
...
* [QLever](https://github.com/ad-freiburg/qlever) ⭐ 903 | 🐛 402 | 🌐 C++ | 📅 2026-09-19 - (OS) a SPARQL engine that can efficiently index and query very large knowledge graphs with over a trillion triples on a single standard PC or server
...
* [Systap Blazegraph™](https://www.blazegraph.com/) - ($/OS).
  ...
  * [docker-blazegraph](https://github.com/lyrasis/docker-blazegraph) ⭐ 27 | 🐛 6 | 🌐 Dockerfile | 📅 2023-11-27
...
* [Virtuoso](https://virtuoso.openlinksw.com/) - ($/OS).
  * [virtuoso-opensource](https://github.com/openlink/virtuoso-opensource) ⭐ 975 | 🐛 676 | 🌐 C | 📅 2026-08-24
...
* [hyrise](https://github.com/hyrise/hyrise) ⭐ 871 | 🐛 93 | 🌐 C++ | 📅 2026-09-18 - Hyrise is a research in-memory database.
...
* [sepa](https://github.com/arces-wot/SEPA) ⭐ 34 | 🐛 29 | 🌐 Java | 📅 2026-09-02 - A JAVA implementation of the SPARQL Event Processing Architecture including the engine, APIs and tools.
...
* [HeFQUIN](https://github.com/LiUSemWeb/HeFQUIN) ⭐ 35 | 🐛 34 | 🌐 Java | 📅 2026-09-19 - A query federation engine for heterogeneous federations of graph data sources.
...
* [QLever](https://github.com/ad-freiburg/QLever) ⭐ 903 | 🐛 402 | 🌐 C++ | 📅 2026-09-19 - Highly efficient query engine for SPARQL+Text.
...
* [Trifid](https://github.com/zazuko/trifid) ⭐ 102 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-18 - Lightweight Linked Data Server and Proxy
...
* [SparqlProg](https://github.com/cmungall/sparqlprog) ⭐ 54 | 🐛 5 | 🌐 Prolog | 📅 2023-01-16 - composable SPARQL using logic programming
...
* [YASGUI Matdata fork](https://github.com/Matdata-eu/yasgui) ⭐ 37 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-14 - Yet Another Sparql GUI - Has more features, bugfixes and upgraded dependencies compared to Zazuko and Triply forks.
...
* [spanqit](https://github.com/anqit/spanqit) ⭐ 13 | 🐛 0 | 🌐 Java | 📅 2024-04-13 - Java-based SPARQL query generator.
...
* [IGUANA](https://github.com/dice-group/IGUANA) ⭐ 26 | 🐛 33 | 🌐 Java | 📅 2026-08-13
* [IGUANA](https://github.com/AKSW/IGUANA) ⭐ 26 | 🐛 33 | 🌐 Java | 📅 2026-08-13 - IGUANA is a benchmark execution framework for triple stores.
* [GTFS-Madrid-Bench](https://github.com/oeg-upm/gtfs-bench) ⭐ 23 | 🐛 6 | 🌐 Python | 📅 2025-03-20 - A benchmark for performance and scalability of knowledge graph construction from heterogeneous data sources
* [FedShop](https://github.com/GDD-Nantes/FedShop) ⭐ 11 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2026-08-01 - A Benchmark for Testing the Scalability of SPARQL Federation Engines
...
* [LDFlex](https://github.com/RubenVerborgh/LDflex) ⭐ 196 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-14 - A JavaScript DSL for querying Linked Data on the Web.
* [HeFQUIN](https://github.com/LiUSemWeb/HeFQUIN) ⭐ 35 | 🐛 34 | 🌐 Java | 📅 2026-09-19 - A query federation engine for heterogeneous federations of graph data sources.
...
* [Justin's Weblog](https://github.com/justin2004/weblog#readme) ⭐ 58 | 🐛 0 | 🌐 Common Lisp | 📅 2026-09-16
...
* [RMLMapper](https://github.com/RMLio/rmlmapper-java) ⭐ 204 | 🐛 63 | 🌐 Java | 📅 2026-02-17 - Java-based RML Processor for transforming heterogeneous data into RDF.
* [RMLStreamer](https://github.com/RMLio/rmlmapper-java) ⭐ 204 | 🐛 63 | 🌐 Java | 📅 2026-02-17 - Flink-based RML Processor for transforming heterogeneous data into RDF in a streaming fashion.
...
* [tarql](https://github.com/tarql/tarql) ⭐ 207 | 🐛 49 | 🌐 Java | 📅 2023-11-02
...
* [JOPA](https://github.com/kbss-cvut/jopa) ⭐ 45 | 🐛 23 | 🌐 Java | 📅 2026-09-18 - A Java object-triple mapping library for RDF4J, Jena and OWL API.
...
* [sparql-gremlin](https://github.com/apache/tinkerpop/tree/master/sparql-gremlin) ⭐ 2,146 | 🐛 32 | 🌐 Java | 📅 2026-09-18 - SPARQL to Gremlin Translator available as a plugin of the popular Apache TinkerPop graph computing framework.
...
* [ontop](https://github.com/ontop/ontop) ⭐ 952 | 🐛 107 | 🌐 Java | 📅 2026-09-17 - Ontop is a platform to query relational databases as Virtual RDF Graphs using SPARQL. It's fast and is packed with features.
* [Morph-KGC](https://github.com/oeg-upm/morph-kgc) ⭐ 290 | 🐛 33 | 🌐 Python | 📅 2026-06-28 - An R2RML engine that creates large knowledge graphs from RDB.
...
* [Morph-KGC](https://github.com/oeg-upm/morph-kgc) ⭐ 290 | 🐛 33 | 🌐 Python | 📅 2026-06-28 - RML and RML-star engine that creates large knowledge graphs from heterogeneous data sources
* [SDM-RDFizer](https://github.com/SDM-TIB/SDM-RDFizer) ⭐ 139 | 🐛 6 | 🌐 Python | 📅 2026-09-16 - RML engine for efficient transformation of CSV, RDB, XML and JSON to RDF
...
* [SPARQL Anything](https://github.com/SPARQL-Anything/sparql.anything) ⭐ 308 | 🐛 63 | 🌐 Java | 📅 2026-09-19 - A system for Semantic Web [re-engineering](https://arxiv.org/pdf/2106.02361.pdf) that allows users to query anything with SPARQL.
...
* [doap](https://github.com/edumbill/doap) ⭐ 288 | 🐛 21 | 🌐 C# | 📅 2024-06-11 - RDF schema for describing software projects.
...
* [Ontology Engineering Curriculum](https://github.com/fabio-rovai/ontology-curriculum) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-08-25 - A free 147-lesson curriculum published as OWL 2 and SKOS, where every lesson is crosswalked to the standard it teaches and a SHACL release gate runs in CI.
...
* [Ontology Development Kit](https://github.com/INCATools/ontology-development-kit/) ⭐ 375 | 🐛 73 | 🌐 Dockerfile | 📅 2026-09-17 - set up a git repo for developing an ontology
...
* [LinkML-Scala](https://github.com/NeverBlink-OSS/linkml-scala) ⭐ 53 | 🐛 5 | 🌐 Scala | 📅 2026-09-18 – fast, portable (JS/JVM/native), and robust implementation of [LinkML](https://linkml.io/).
* [dosdp-tools](https://github.com/INCATools/dosdp-tools/) ⭐ 33 | 🐛 38 | 🌐 Scala | 📅 2026-05-21 - dead simple owl design patterns (template tool)
* [OWLSharp](https://github.com/mdesalvo/OWLSharp) ⭐ 17 | 🐛 0 | 🌐 C# | 📅 2026-09-19 - .NET library for OWL2-DL ontology modeling, validation and reasoning
...
* [Pellet](https://github.com/stardog-union/pellet) ⭐ 355 | 🐛 27 | 🌐 Web Ontology Language | 📅 2017-01-05
* [OWL-RL](https://github.com/RDFLib/OWL-RL) ⭐ 178 | 🐛 26 | 🌐 HTML | 📅 2026-08-06
* [eye](https://github.com/josd/eye) ⭐ 174 | 🐛 25 | 🌐 Prolog | 📅 2026-09-07 - Euler Yet another proof Engine.
* [reasonable](https://github.com/gtfierro/reasonable) ⭐ 136 | 🐛 9 | 🌐 Rust | 📅 2026-09-18 - OWL 2 Reasoner built on DataFrog
* [openllet](https://github.com/Galigator/openllet) ⭐ 135 | 🐛 46 | 🌐 Java | 📅 2025-08-04
* [ELK](https://github.com/liveontologies/elk-reasoner) ⭐ 129 | 🐛 23 | 🌐 Java | 📅 2026-06-13
...
* [cowl](https://github.com/sisinflab-swot/cowl) ⭐ 45 | 🐛 2 | 🌐 C | 📅 2026-09-08 - A lightweight C API for working with OWL ontologies.
...
* [hdt-cpp](https://github.com/rdfhdt/hdt-cpp) ⭐ 127 | 🐛 65 | 🌐 C++ | 📅 2026-09-01 - Read and query [HDT](https://www.rdfhdt.org/)
...
* [csv2rdf (clojure)](https://github.com/Swirrl/csv2rdf) ⭐ 31 | 🐛 43 | 🌐 HTML | 📅 2026-09-01 - Clojure library and application for converting CSV to RDF
* [seabass](https://github.com/ryankohl/seabass) ⭐ 29 | 🐛 0 | 🌐 Clojure | 📅 2016-07-23 - A library for working with RDF with Jena in Clojure.
* [matcha](https://github.com/Swirrl/matcha) ⭐ 24 | 🐛 51 | 🌐 Clojure | 📅 2026-09-01 - :tea: SPARQL-like DSL for querying in-memory Linked Data Models
...
* [rdf2go](https://github.com/deiu/rdf2go) ⭐ 81 | 🐛 0 | 🌐 Go | 📅 2026-09-10 - Native golang library for RDF.
* [knakk/rdf](https://github.com/knakk/rdf) ⭐ 76 | 🐛 8 | 🌐 Go | 📅 2026-09-07 - RDF library for Go.
* [rdfkit-go](https://github.com/dpb587/rdfkit-go) ⭐ 7 | 🐛 0 | 🌐 Go | 📅 2026-09-15 - decoders, encoders, and other RDF primitives for Go.
...
* [titanium-json-ld](https://github.com/filip26/titanium-json-ld) ⭐ 167 | 🐛 10 | 🌐 Java | 📅 2026-07-27 - An implementation of the JSON-LD 1.1 (JSON-based Serialization for Linked Data) specification in Java utilizing Jakarta JSON Processing.
...
* [N3.js](https://github.com/RubenVerborgh/N3.js) ⭐ 796 | 🐛 63 | 🌐 JavaScript | 📅 2026-09-14
* [rdflib.js](https://github.com/linkeddata/rdflib.js) ⭐ 597 | 🐛 138 | 🌐 HTML | 📅 2026-09-18 - Linked Data API for JavaScript.
...
* [shex.js](https://github.com/shexSpec/shex.js) ⭐ 62 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-15 - JavaScript implementation of Shape Expressions (ShEx).
...
* [Unravel-RDF](https://github.com/p2m2/unravel-rdf) ⭐ 0 | 🐛 0 | 🌐 Scala | 📅 2026-07-19 - JavaScript developer-oriented query abstraction for building interactive applications over RDF knowledge graphs.
...
* sweetrdf - Collection of RDF-libraries using modern PHP functionality
  * [rdfInterface](https://github.com/sweetrdf/rdfInterface) ⭐ 7 | 🐛 2 | 🌐 PHP | 📅 2026-09-10 - Common interfaces for each RDF stack layer (parser, serializer, dataset, SPARQL client, etc.) to enable interoperability between different implementations. Think of it as PSR for RDF.
  ...
  * [quickRdfIo](https://github.com/sweetrdf/quickRdfIo) ⭐ 2 | 🐛 0 | 🌐 PHP | 📅 2026-09-10 - Collection of RDF parsers and serializers (using rdfInterface)
...
* [RDFlib](https://github.com/RDFLib/rdflib) ⭐ 2,515 | 🐛 383 | 🌐 Python | 📅 2026-09-16 - A Python library for RDF manipulation, storage & serialization.
...
* [kglab](https://github.com/DerwenAI/kglab/) ⭐ 691 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2026-01-25 -  The kglab library provides a simple abstraction layer in Python for building knowledge graphs.
* [SPARQLWrapper](https://github.com/RDFLib/sparqlwrapper) ⭐ 568 | 🐛 54 | 🌐 Python | 📅 2026-04-30 - A wrapper for a remote SPARQL endpoint.
...
* [OWL-RL](https://github.com/RDFLib/OWL-RL) ⭐ 178 | 🐛 26 | 🌐 HTML | 📅 2026-08-06 - A simple implementation of the OWL2 RL Profile on top of RDFLib.
...
* [open-kgo](https://github.com/mloda-ai/open-kgo) ⭐ 11 | 🐛 3 | 🌐 Python | 📅 2026-09-18 - Unified Python API over nine knowledge-graph backend families (including RDF/SPARQL) that validates each traversal against a declared ontology and rejects semantically invalid hops.
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,921 | 🐛 154 | 🌐 Rust | 📅 2026-09-18 - Oxigraph is a graph database implementing the SPARQL standard.
* [sophia\_rs](https://github.com/pchampin/sophia_rs) ⭐ 331 | 🐛 24 | 🌐 Rust | 📅 2026-08-20 - Sophia: a Rust toolkit for RDF and Linked Data.
* [Horned OWL](https://github.com/phillord/horned-owl) ⭐ 105 | 🐛 16 | 🌐 Rust | 📅 2026-09-18 - Horned-OWL is a library for manipulating OWL data.
...
* [PurRDF](https://github.com/Blackcat-Informatics/purrdf) ⭐ 46 | 🐛 19 | 🌐 Rust | 📅 2026-09-19 - RDF 1.2 engine with SPARQL, SHACL, ShEx and entailment, exposing one identical behaviour in Rust, Python, WebAssembly and C.
...
* [ttl-mode](https://github.com/jeeger/ttl-mode) ⭐ 13 | 🐛 1 | 🌐 Emacs Lisp | 📅 2026-09-15 - Supports both ttl and n3, indentation, some electric punctuation and hungry delete.
...
* [RickView](https://github.com/konradhoeffner/rickview) ⭐ 37 | 🐛 15 | 🌐 Rust | 📅 2026-09-17 - RDF browser for small knowledge bases written in Rust using an in-memory graph, doesn't require a SPARQL endpoint. Optimized for high performance and low resource usage.
* [RhizomerEye](https://github.com/rhizomik/rhizomerEye) ⭐ 20 | 🐛 12 | 🌐 TypeScript | 📅 2025-08-05 - A [Web application](https://rhizomik.net/rhizomer) for interactive exploration of semantic and linked data available from SPARQL endpoints.
...
* [Sparnatural](https://github.com/sparna-git/Sparnatural) ⭐ 309 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-17
...
* [Reactodia](https://github.com/reactodia/reactodia-workspace) ⭐ 32 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-08 - Ontodia fork with additional features such as grouping and annotations
...
* [Weviate](https://github.com/creativesoftwarefdn/weaviate) ⭐ 16,825 | 🐛 741 | 🌐 Go | 📅 2026-09-19
...
* [comunica](https://github.com/comunica/comunica) ⭐ 602 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-18 - Flexible meta query engine for the Web.
...
* [pyLDAPI](https://github.com/rdflib/pyLDAPI) ⭐ 43 | 🐛 10 | 🌐 Python | 📅 2025-01-18 - A Python [rdflib](https://github.com/rdflib/RDFlib/) ⭐ 2,515 | 🐛 383 | 🌐 Python | 📅 2026-09-16-based API framework for Linked Data via the W3C's [Content Negotiation by Profile](https://w3c.github.io/dx-connegp/connegp/)
...
* [Widoco](https://github.com/dgarijo/Widoco) ⭐ 398 | 🐛 154 | 🌐 JavaScript | 📅 2026-09-01 - A Wizard for documenting and publishing ontologies on the Web.
* [tawny-owl](https://github.com/phillord/tawny-owl) ⭐ 281 | 🐛 14 | 🌐 Clojure | 📅 2026-05-08 - Build OWL Ontologies in a Programmatic Environment.
* [pyLODE](https://github.com/rdflib/pyLODE/) ⭐ 228 | 🐛 80 | 🌐 Python | 📅 2026-09-19 - A Python [rdflib](https://github.com/rdflib/RDFlib/) ⭐ 2,515 | 🐛 383 | 🌐 Python | 📅 2026-09-16-based implementation of the [LODE](http://ceur-ws.org/Vol-932/paper12.pdf) ontology documentation tool
* [grlc](https://github.com/CLARIAH/grlc) ⭐ 151 | 🐛 35 | 🌐 Python | 📅 2026-09-01 - Web APIs from SPARQL queries.
* [Web-Client](https://github.com/AtomGraph/Web-Client) ⭐ 123 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-18 - Generic Linked Data browser and UX component framework.
* [OnToology](https://github.com/OnToology/OnToology) ⭐ 114 | 🐛 85 | 🌐 Python | 📅 2026-06-11 - A system for collaborative ontology development. Given a GitHub repository with an OWL file, OnToology will survey it and produce diagrams, a complete documentation and validation based on common pitfalls.
...
* [schema\_salad](https://github.com/common-workflow-language/schema_salad) ⭐ 86 | 🐛 93 | 🌐 Python | 📅 2026-09-18 - Semantic Annotations for Linked Avro Data.
...
* [Git2PROV](https://github.com/mmlab/Git2PROV) ⭐ 37 | 🐛 11 | 🌐 JavaScript | 📅 2023-01-23 - Unleash the potential of Git in the new W3C standard for provenance.
...
* [ont-converter](https://github.com/sszuev/ont-converter) ⭐ 24 | 🐛 1 | 🌐 Kotlin | 📅 2023-03-12 - Written in Kotlin, a simple command-line utility to convert any RDF graph to OWL2 ontology.
...
- [Qlue-ls](https://github.com/IoannisNezis/Qlue-ls) ⭐ 49 | 🐛 10 | 🌐 Rust | 📅 2026-09-17 - A powerfull SPARQL language server and formatter. Providing: auto-completion, hover-info, formatting, code-actions, diagnostics and more.
- [rdfless](https://github.com/larsw/rdfless/) ⭐ 8 | 🐛 1 | 🌐 Rust | 📅 2026-09-19 - A pager and pretty-printer for Turtle/TriG/N-triples and N-Quads written in Rust.
...
* [OntoGPT](https://github.com/monarch-initiative/ontogpt/) ⭐ 1,017 | 🐛 80 | 🌐 Jupyter Notebook | 📅 2026-09-10 - Tools for populating semantic schemas from unstructured text using Large Language Models (LLMs)
...
* [LinkedPipes-ETL](https://github.com/linkedpipes/etl) ⭐ 162 | 🐛 198 | 🌐 Java | 📅 2026-06-12 - Linked Data ETL pipeline.
...
* [labra/shaclex](https://github.com/labra/shaclex) ⭐ 92 | 🐛 261 | 🌐 Scala | 📅 2025-04-12
...
* [atramhasis](https://github.com/OnroerendErfgoed/atramhasis) ⭐ 64 | 🐛 57 | 🌐 Python | 📅 2026-09-18
...
* [LoRiS](https://github.com/WSE-research/LoRiS-LLM-generated-Representations-of-SPARQL-queries) ⭐ 8 | 🐛 4 | 🌐 Python | 📅 2026-09-13 generated natural-language representations of SPARQL queries over Wikidata and DBpedia.
...
* [fester](https://github.com/UCLALibrary/fester) ⭐ 4 | 🐛 0 | 🌐 Java | 📅 2026-09-01
* [IIIF](https://iiif.io/)

## Other Awesome

* [totogo/awesome-knowledge-graph](https://github.com/totogo/awesome-knowledge-graph) ⭐ 1,892 | 🐛 23 | 📅 2026-09-11

* [shaoxiongi/awesome-knowlege-graph](https://github.com/shaoxiongji/awesome-knowledge-graph) ⭐ 1,795 | 🐛 0 | 🌐 JavaScript | 📅 2022-10-07
...
* [OWL-API](https://github.com/owlcs/owlapi) ⭐ 932 | 🐛 107 | 🌐 Java | 📅 2026-09-06 - The OWL API is a Java API for creating, manipulating and serialising OWL Ontologies.

* [awesome-ontology](https://github.com/ozekik/awesome-ontology) ⭐ 701 | 🐛 1 | 📅 2026-06-07 - Similar to this list
...
* [amazon-neptune-tools](https://github.com/awslabs/amazon-neptune-tools) ⭐ 314 | 🐛 10 | 🌐 Python | 📅 2026-09-14 - Tools and utilities to enable loading data and building graph applications with Amazon Neptune.

* [kbpedia](https://github.com/Cognonto/kbpedia) ⭐ 239 | 🐛 2 | 📅 2020-08-04 - KBPedia Knowledge Graph & Knowledge Ontology (KKO).
...
* [grlc](https://github.com/CLARIAH/grlc) ⭐ 151 | 🐛 35 | 🌐 Python | 📅 2026-09-01 - Translates public SPARQL queries into Linked Data APIs automatically.
...
* [vocol](https://github.com/vocol/vocol) ⭐ 100 | 🐛 28 | 🌐 JavaScript | 📅 2022-12-14 - An integrated environment to support collaborative ontology / vocabulary development in distributed settings.

* [vocol](https://github.com/vocol/vocol) ⭐ 100 | 🐛 28 | 🌐 JavaScript | 📅 2022-12-14 - An integrated environment to support collaborative ontology / vocabulary development in distributed settings.

* [activitystreams](https://github.com/OpenSocial/activitystreams) ⭐ 94 | 🐛 8 | 🌐 Java | 📅 2022-11-11

* [jsonld-streaming-parser.js](https://github.com/rubensworks/jsonld-streaming-parser.js) ⭐ 91 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-10 - A fast and lightweight streaming JSON-LD parser for JavaScript.
...
* [Awesome Knowledge Graph Construction Tools](https://github.com/kg-construct/awesome-kgc-tools) ⭐ 87 | 🐛 1 | 📅 2026-06-03
...
* [json-ld-macros](https://github.com/antoniogarrote/json-ld-macros) ⭐ 68 | 🐛 4 | 🌐 JavaScript | 📅 2016-06-01  Declarative transformation of JSON APIs into JSON-LD.
...
* [ONT-API](https://github.com/owlcs/ont-api) ⭐ 51 | 🐛 4 | 🌐 Java | 📅 2026-09-09 - a Jena based OWL-API implementation (Java library).
...
* [MOD-Ontology](https://github.com/sifrproject/MOD-Ontology) ⭐ 37 | 🐛 44 | 📅 2026-06-04 - Metadata for Ontology Description and Publication Ontology .

* [redland-bindings](https://github.com/dajobe/redland-bindings) ⭐ 36 | 🐛 3 | 🌐 Perl | 📅 2026-07-15 - Redland librdf language bindings.

* [linked-csv](https://github.com/JeniT/linked-csv) ⭐ 34 | 🐛 4 | 🌐 XML | 📅 2013-04-19 - A souped-up CSV-based data format.

* [SEPA](https://github.com/arces-wot/SEPA) ⭐ 34 | 🐛 29 | 🌐 Java | 📅 2026-09-02 - A JAVA implementation of the SPARQL Event Processing Architecture including the engine, APIs and tools.

* [SEPA](https://github.com/arces-wot/SEPA) ⭐ 34 | 🐛 29 | 🌐 Java | 📅 2026-09-02 - A JAVA implementation of the SPARQL Event Processing Architecture including the engine, APIs and tools.

* [SEPA](https://github.com/arces-wot/SEPA/blob/master/README.md) ⭐ 34 | 🐛 29 | 🌐 Java | 📅 2026-09-02

* [nanopub-java](https://github.com/Nanopublication/nanopub-java) ⭐ 33 | 🐛 25 | 🌐 Java | 📅 2026-09-16
