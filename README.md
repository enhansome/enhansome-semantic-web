...
To add something to the list please either submit a pull request or add a comment with a link to [issues/awesomelets](https://github.com/semantalytics/awesome-semantic-web/issues/81) ⭐ 1,685 | 🐛 29 | 📅 2026-09-08. Pull requests will be evaluated immediately for inclusion while awesomelets will be evaluated at some indeterminate time in the future.

Looking for something but can't find it? Add it to the ["Does it exist"](https://github.com/semantalytics/awesome-semantic-web/issues/74) ⭐ 1,685 | 🐛 29 | 📅 2026-09-08 list and we'll keep an eye out for it. If it's a good idea maybe someone will come along and create it!
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,875 | 🐛 149 | 🌐 Rust | 📅 2026-09-10 - (OS) a graph database implementing the SPARQL standard and written in Rust.
...
* [QLever](https://github.com/ad-freiburg/qlever) ⭐ 897 | 🐛 412 | 🌐 C++ | 📅 2026-09-10 - (OS) a SPARQL engine that can efficiently index and query very large knowledge graphs with over a trillion triples on a single standard PC or server
...
* [MillenniumDB](https://github.com/MillenniumDB/MillenniumDB) ⭐ 264 | 🐛 2 | 🌐 C++ | 📅 2026-08-17 - (OS)
...
* [Virtuoso](https://virtuoso.openlinksw.com/) - ($/OS).
  * [virtuoso-opensource](https://github.com/openlink/virtuoso-opensource) ⭐ 974 | 🐛 673 | 🌐 C | 📅 2026-08-24
...
* [HeFQUIN](https://github.com/LiUSemWeb/HeFQUIN) ⭐ 35 | 🐛 36 | 🌐 Java | 📅 2026-09-10 - A query federation engine for heterogeneous federations of graph data sources.
...
* [QLever](https://github.com/ad-freiburg/QLever) ⭐ 897 | 🐛 412 | 🌐 C++ | 📅 2026-09-10 - Highly efficient query engine for SPARQL+Text.
...
* [Trifid](https://github.com/zazuko/trifid) ⭐ 102 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-10 - Lightweight Linked Data Server and Proxy
...
* [RMLMapper](https://github.com/RMLio/rmlmapper-java) ⭐ 202 | 🐛 63 | 🌐 Java | 📅 2026-02-17 - Java-based RML Processor for transforming heterogeneous data into RDF.
* [RMLStreamer](https://github.com/RMLio/rmlmapper-java) ⭐ 202 | 🐛 63 | 🌐 Java | 📅 2026-02-17 - Flink-based RML Processor for transforming heterogeneous data into RDF in a streaming fashion.
...
* [JOPA](https://github.com/kbss-cvut/jopa) ⭐ 44 | 🐛 21 | 🌐 Java | 📅 2026-09-09 - A Java object-triple mapping library for RDF4J, Jena and OWL API.
...
* [sparql-gremlin](https://github.com/apache/tinkerpop/tree/master/sparql-gremlin) ⭐ 2,144 | 🐛 32 | 🌐 Java | 📅 2026-09-10 - SPARQL to Gremlin Translator available as a plugin of the popular Apache TinkerPop graph computing framework.
...
* [ontop](https://github.com/ontop/ontop) ⭐ 944 | 🐛 107 | 🌐 Java | 📅 2026-07-13 - Ontop is a platform to query relational databases as Virtual RDF Graphs using SPARQL. It's fast and is packed with features.
...
* [RMLMapper](https://github.com/RMLio/rmlmapper-java) ⭐ 202 | 🐛 63 | 🌐 Java | 📅 2026-02-17 - Java-based RML Processor backwards compatible with R2RML.
...
* [SPARQL Anything](https://github.com/SPARQL-Anything/sparql.anything) ⭐ 308 | 🐛 61 | 🌐 Java | 📅 2026-09-10 - A system for Semantic Web [re-engineering](https://arxiv.org/pdf/2106.02361.pdf) that allows users to query anything with SPARQL.
...
* [Ontology Development Kit](https://github.com/INCATools/ontology-development-kit/) ⭐ 371 | 🐛 78 | 🌐 Dockerfile | 📅 2026-09-07 - set up a git repo for developing an ontology
...
* [LinkML-Scala](https://github.com/NeverBlink-OSS/linkml-scala) ⭐ 48 | 🐛 7 | 🌐 Scala | 📅 2026-09-10 – fast, portable (JS/JVM/native), and robust implementation of [LinkML](https://linkml.io/).
...
* [openllet](https://github.com/Galigator/openllet) ⭐ 132 | 🐛 45 | 🌐 Java | 📅 2025-08-04
...
* [FaCT++](https://github.com/ethz-asl/libfactplusplus) ⚠️ Archived and [pyfactxx](https://github.com/tilde-lab/pyfactxx) ⭐ 31 | 🐛 8 | 🌐 Java | 📅 2026-09-07
...
* [RDFlib](https://github.com/RDFLib/rdflib) ⭐ 2,511 | 🐛 384 | 🌐 Python | 📅 2026-09-09 - A Python library for RDF manipulation, storage & serialization.
...
* [open-kgo](https://github.com/mloda-ai/open-kgo) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2026-09-06 - Unified Python API over nine knowledge-graph backend families (including RDF/SPARQL) that validates each traversal against a declared ontology and rejects semantically invalid hops.
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,875 | 🐛 149 | 🌐 Rust | 📅 2026-09-10 - Oxigraph is a graph database implementing the SPARQL standard.
* [sophia\_rs](https://github.com/pchampin/sophia_rs) ⭐ 331 | 🐛 24 | 🌐 Rust | 📅 2026-08-20 - Sophia: a Rust toolkit for RDF and Linked Data.
* [Horned OWL](https://github.com/phillord/horned-owl) ⭐ 104 | 🐛 18 | 🌐 Rust | 📅 2026-09-03 - Horned-OWL is a library for manipulating OWL data.
...
* [PurRDF](https://github.com/Blackcat-Informatics/purrdf) ⭐ 45 | 🐛 7 | 🌐 Rust | 📅 2026-09-10 - RDF 1.2 engine with SPARQL, SHACL, ShEx and entailment, exposing one identical behaviour in Rust, Python, WebAssembly and C.
...
* [Sparnatural](https://github.com/sparna-git/Sparnatural) ⭐ 306 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-10
...
* [Reactodia](https://github.com/reactodia/reactodia-workspace) ⭐ 30 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-08 - Ontodia fork with additional features such as grouping and annotations
...
* [Weviate](https://github.com/creativesoftwarefdn/weaviate) ⭐ 16,799 | 🐛 738 | 🌐 Go | 📅 2026-09-10
...
* [comunica](https://github.com/comunica/comunica) ⭐ 584 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-10 - Flexible meta query engine for the Web.
...
* [pyLDAPI](https://github.com/rdflib/pyLDAPI) ⭐ 43 | 🐛 10 | 🌐 Python | 📅 2025-01-18 - A Python [rdflib](https://github.com/rdflib/RDFlib/) ⭐ 2,511 | 🐛 384 | 🌐 Python | 📅 2026-09-09-based API framework for Linked Data via the W3C's [Content Negotiation by Profile](https://w3c.github.io/dx-connegp/connegp/)
...
* [pyLODE](https://github.com/rdflib/pyLODE/) ⭐ 227 | 🐛 78 | 🌐 Python | 📅 2026-08-17 - A Python [rdflib](https://github.com/rdflib/RDFlib/) ⭐ 2,511 | 🐛 384 | 🌐 Python | 📅 2026-09-09-based implementation of the [LODE](http://ceur-ws.org/Vol-932/paper12.pdf) ontology documentation tool
* [grlc](https://github.com/CLARIAH/grlc) ⭐ 151 | 🐛 35 | 🌐 Python | 📅 2026-09-01 - Web APIs from SPARQL queries.
* [Web-Client](https://github.com/AtomGraph/Web-Client) ⭐ 123 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-10 - Generic Linked Data browser and UX component framework.
...
- [Qlue-ls](https://github.com/IoannisNezis/Qlue-ls) ⭐ 49 | 🐛 11 | 🌐 Rust | 📅 2026-09-10 - A powerfull SPARQL language server and formatter. Providing: auto-completion, hover-info, formatting, code-actions, diagnostics and more.
...
* [OntoGPT](https://github.com/monarch-initiative/ontogpt/) ⭐ 1,007 | 🐛 80 | 🌐 Jupyter Notebook | 📅 2026-09-10 - Tools for populating semantic schemas from unstructured text using Large Language Models (LLMs)
...
* [totogo/awesome-knowledge-graph](https://github.com/totogo/awesome-knowledge-graph) ⭐ 1,888 | 🐛 23 | 📅 2026-02-28
...
* [OWL-API](https://github.com/owlcs/owlapi) ⭐ 927 | 🐛 107 | 🌐 Java | 📅 2026-09-06 - The OWL API is a Java API for creating, manipulating and serialising OWL Ontologies.
...
* [nanopub-java](https://github.com/Nanopublication/nanopub-java) ⭐ 33 | 🐛 25 | 🌐 Java | 📅 2026-09-10
