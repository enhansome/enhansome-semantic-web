...
To add something to the list please either submit a pull request or add a comment with a link to [issues/awesomelets](https://github.com/semantalytics/awesome-semantic-web/issues/81) ⭐ 1,687 | 🐛 31 | 📅 2026-09-08. Pull requests will be evaluated immediately for inclusion while awesomelets will be evaluated at some indeterminate time in the future.

Looking for something but can't find it? Add it to the ["Does it exist"](https://github.com/semantalytics/awesome-semantic-web/issues/74) ⭐ 1,687 | 🐛 31 | 📅 2026-09-08 list and we'll keep an eye out for it. If it's a good idea maybe someone will come along and create it!
...
* [See list of RDF Triple Store propducts](https://github.com/graphgeeks-lab/awesome-graph-universe?tab=readme-ov-file#triple-stores-rdf-databases) ⭐ 163 | 🐛 7 | 📅 2025-08-26
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,880 | 🐛 149 | 🌐 Rust | 📅 2026-09-13 - (OS) a graph database implementing the SPARQL standard and written in Rust.
...
* [QLever](https://github.com/ad-freiburg/qlever) ⭐ 899 | 🐛 407 | 🌐 C++ | 📅 2026-09-13 - (OS) a SPARQL engine that can efficiently index and query very large knowledge graphs with over a trillion triples on a single standard PC or server
* [gStore](https://github.com/pkumod/gStore) ⭐ 838 | 🐛 26 | 🌐 C++ | 📅 2026-04-09 - (OS) - a graph based RDF triple store.
...
* [hyrise](https://github.com/hyrise/hyrise) ⭐ 871 | 🐛 92 | 🌐 C++ | 📅 2026-09-10 - Hyrise is a research in-memory database.
...
* [HeFQUIN](https://github.com/LiUSemWeb/HeFQUIN) ⭐ 35 | 🐛 34 | 🌐 Java | 📅 2026-09-11 - A query federation engine for heterogeneous federations of graph data sources.
...
* [QLever](https://github.com/ad-freiburg/QLever) ⭐ 899 | 🐛 407 | 🌐 C++ | 📅 2026-09-13 - Highly efficient query engine for SPARQL+Text.
...
* [SEPA](https://github.com/arces-wot/SEPA) ⭐ 34 | 🐛 29 | 🌐 Java | 📅 2026-09-02 - A JAVA implementation of the SPARQL Event Processing Architecture including the engine, APIs and tools.
* [YASGUI Matdata fork](https://github.com/Matdata-eu/yasgui) ⭐ 33 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-13 - Yet Another Sparql GUI - Has more features, bugfixes and upgraded dependencies compared to Zazuko and Triply forks.
...
* [LDFlex](https://github.com/RubenVerborgh/LDflex) ⭐ 196 | 🐛 37 | 🌐 JavaScript | 📅 2026-08-31 - A JavaScript DSL for querying Linked Data on the Web.
* [HeFQUIN](https://github.com/LiUSemWeb/HeFQUIN) ⭐ 35 | 🐛 34 | 🌐 Java | 📅 2026-09-11 - A query federation engine for heterogeneous federations of graph data sources.
...
* [Justin's Weblog](https://github.com/justin2004/weblog#readme) ⭐ 58 | 🐛 0 | 🌐 Common Lisp | 📅 2026-09-11
...
* [JOPA](https://github.com/kbss-cvut/jopa) ⭐ 45 | 🐛 21 | 🌐 Java | 📅 2026-09-09 - A Java object-triple mapping library for RDF4J, Jena and OWL API.
...
* [sparql-gremlin](https://github.com/apache/tinkerpop/tree/master/sparql-gremlin) ⭐ 2,145 | 🐛 31 | 🌐 Java | 📅 2026-09-11 - SPARQL to Gremlin Translator available as a plugin of the popular Apache TinkerPop graph computing framework.
...
* [SPARQL Anything](https://github.com/SPARQL-Anything/sparql.anything) ⭐ 308 | 🐛 61 | 🌐 Java | 📅 2026-09-13 - A system for Semantic Web [re-engineering](https://arxiv.org/pdf/2106.02361.pdf) that allows users to query anything with SPARQL.
...
* [Ontology Development Kit](https://github.com/INCATools/ontology-development-kit/) ⭐ 374 | 🐛 82 | 🌐 Dockerfile | 📅 2026-09-13 - set up a git repo for developing an ontology
...
* [LinkML-Scala](https://github.com/NeverBlink-OSS/linkml-scala) ⭐ 49 | 🐛 4 | 🌐 Scala | 📅 2026-09-13 – fast, portable (JS/JVM/native), and robust implementation of [LinkML](https://linkml.io/).
...
* [ELK](https://github.com/liveontologies/elk-reasoner) ⭐ 126 | 🐛 23 | 🌐 Java | 📅 2026-06-13
...
* [N3.js](https://github.com/RubenVerborgh/N3.js) ⭐ 796 | 🐛 63 | 🌐 JavaScript | 📅 2026-09-10
* [rdflib.js](https://github.com/linkeddata/rdflib.js) ⭐ 597 | 🐛 137 | 🌐 HTML | 📅 2026-09-10 - Linked Data API for JavaScript.
...
* [rdf-ext](https://github.com/rdf-ext/rdf-ext) ⭐ 126 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-04
...
* [shex.js](https://github.com/shexSpec/shex.js) ⭐ 62 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-10 - JavaScript implementation of Shape Expressions (ShEx).
...
* [RDFlib](https://github.com/RDFLib/rdflib) ⭐ 2,511 | 🐛 386 | 🌐 Python | 📅 2026-09-09 - A Python library for RDF manipulation, storage & serialization.
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,880 | 🐛 149 | 🌐 Rust | 📅 2026-09-13 - Oxigraph is a graph database implementing the SPARQL standard.
...
* [PurRDF](https://github.com/Blackcat-Informatics/purrdf) ⭐ 45 | 🐛 7 | 🌐 Rust | 📅 2026-09-13 - RDF 1.2 engine with SPARQL, SHACL, ShEx and entailment, exposing one identical behaviour in Rust, Python, WebAssembly and C.
...
* [ELOT](https://github.com/johanwk/elot) ⭐ 33 | 🐛 14 | 🌐 Emacs Lisp | 📅 2026-09-10 - Emacs Literate Ontology Tool, write OWL ontologies using org-mode
...
* [Sparnatural](https://github.com/sparna-git/Sparnatural) ⭐ 307 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-11
...
* [Weviate](https://github.com/creativesoftwarefdn/weaviate) ⭐ 16,805 | 🐛 746 | 🌐 Go | 📅 2026-09-13
...
* [comunica](https://github.com/comunica/comunica) ⭐ 592 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-12 - Flexible meta query engine for the Web.
...
* [pyLDAPI](https://github.com/rdflib/pyLDAPI) ⭐ 43 | 🐛 10 | 🌐 Python | 📅 2025-01-18 - A Python [rdflib](https://github.com/rdflib/RDFlib/) ⭐ 2,511 | 🐛 386 | 🌐 Python | 📅 2026-09-09-based API framework for Linked Data via the W3C's [Content Negotiation by Profile](https://w3c.github.io/dx-connegp/connegp/)
...
* [pyLODE](https://github.com/rdflib/pyLODE/) ⭐ 227 | 🐛 78 | 🌐 Python | 📅 2026-08-17 - A Python [rdflib](https://github.com/rdflib/RDFlib/) ⭐ 2,511 | 🐛 386 | 🌐 Python | 📅 2026-09-09-based implementation of the [LODE](http://ceur-ws.org/Vol-932/paper12.pdf) ontology documentation tool
* [grlc](https://github.com/CLARIAH/grlc) ⭐ 151 | 🐛 35 | 🌐 Python | 📅 2026-09-01 - Web APIs from SPARQL queries.
* [Web-Client](https://github.com/AtomGraph/Web-Client) ⭐ 123 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-13 - Generic Linked Data browser and UX component framework.
...
- [Qlue-ls](https://github.com/IoannisNezis/Qlue-ls) ⭐ 49 | 🐛 9 | 🌐 Rust | 📅 2026-09-13 - A powerfull SPARQL language server and formatter. Providing: auto-completion, hover-info, formatting, code-actions, diagnostics and more.
- [rdfless](https://github.com/larsw/rdfless/) ⭐ 8 | 🐛 2 | 🌐 Rust | 📅 2026-09-09 - A pager and pretty-printer for Turtle/TriG/N-triples and N-Quads written in Rust.
...
* [OntoGPT](https://github.com/monarch-initiative/ontogpt/) ⭐ 1,009 | 🐛 80 | 🌐 Jupyter Notebook | 📅 2026-09-10 - Tools for populating semantic schemas from unstructured text using Large Language Models (LLMs)
...
* [pySHACL](https://github.com/RDFLib/pySHACL) ⭐ 346 | 🐛 45 | 🌐 Python | 📅 2026-07-28 - A Python validator for SHACL.
...
* [awesome-ontology](https://github.com/ozekik/awesome-ontology) ⭐ 695 | 🐛 1 | 📅 2026-06-07 - Similar to this list
...
* [amazon-neptune-tools](https://github.com/awslabs/amazon-neptune-tools) ⭐ 314 | 🐛 12 | 🌐 Python | 📅 2026-09-10 - Tools and utilities to enable loading data and building graph applications with Amazon Neptune.
...
* [nanopub-java](https://github.com/Nanopublication/nanopub-java) ⭐ 33 | 🐛 24 | 🌐 Java | 📅 2026-09-13
